...
const DetailHotelsCard = ({ pic, rating, name, location, price, day }) => {
  return (
    <li className="min-[380px]:w-[250px] sm:w-[282px] relative">
      ...
      <div className="flex items-center justify-between">
        <button className=" min-[380px]:w-[150px] sm:w-[172px] rounded-[16px] bg-[#3276ff33] backdrop-blur-[2px] p-4 text-[#3276FF] font-medium ">Забронировать</button>
        <div>
          <span className="font-bold">{price}</span>
          <span className="text-xs text-[#777E90]">{day}</span>
        </div>
      </div>
    </li>
  )
...
export default DetailHotelsCard
