          ...
          <div className="flex gap-6">
            <div className="flex flex-col gap-6 lg:flex-row ">
              <div className="flex flex-col ">
                ...
                <select className=" relative w-[280px] md:w-[220px] bg-[#F8F8FA] rounded-2xl py-4 pe-4 ps-[52px] appearance-none  "
                  style={{
              ...
              <div className="flex flex-col">
                ...
                <select className=" relative w-[280px]  md:w-[200px] bg-[#F8F8FA] rounded-2xl py-4 pe-4 ps-[52px] appearance-none  "
                  style={{
