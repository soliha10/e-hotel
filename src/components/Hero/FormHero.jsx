...
const FormHero = () => {
  return (
    <div className="absolute bg-white w-[95%] lg:w-full left-auto  p-8 md:p-12 rounded-[40px] shadow-lg top-11   ">
      <div>
        <ul className="flex min-[380px]:gap-2 sm:gap-4 lg:gap-6 text-[#777E90] border-b pb-[30px] mb-12 ">
        ...
        <form action="" className="flex gap-6 sm:items-end justify-center flex-col  lg:justify-start md:flex-row  ">
          <div className="flex md:gap-6 min-[380px]:gap-2 flex-wrap justify-between ">
            <div className="flex min-[380px]:flex-col gap-6 sm:flex-row ">
              <div className="flex flex-col ">
                <label className="text-[#777E90] text-sm mb-3" >Куда хотите поехать?</label>
                <select className=" relative min-[380px]:w-[150px] min-[380px]:text-xs sm:w-[280px] md:w-[220px] md:text-base bg-[#F8F8FA] rounded-2xl py-4 pe-4 ps-[52px] appearance-none  "
                  style={{
              ...
              <div className="flex flex-col">
                ...
                <select className=" relative min-[380px]:w-[150px] sm:w-[280px] min-[380px]:text-xs md:text-base  md:w-[200px] bg-[#F8F8FA] rounded-2xl py-4 pe-4 ps-[52px] appearance-none  "
                  style={{
            ...
            <div className="flex min-[380px]:flex-col gap-6 sm:flex-row">
              <div className="flex flex-col">
                ...
                <select className=" relative min-[380px]:w-[150px] min-[380px]:text-xs sm:w-[280px] md:text-base  md:w-[200px] bg-[#F8F8FA] rounded-2xl py-4 pe-4 ps-[52px] appearance-none   "
                  style={{
                    backgroundImage: `url(${date})`,
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: "left 16px center",
