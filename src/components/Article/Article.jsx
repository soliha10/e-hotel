  ...
  return (
    <article className="pb-[100px]">
      <div className="w-full max-w-[1240px] mx-auto px-5">
        <div className="py-10 md:py-[60px] px-12 md:px-[80px] rounded-[40px] min-[380px]:bg-[#E3E6EC]  "
       style={{
        ...
        >
          <div className='w-full max-w-[610px] '>
            <h2 className=" text-[#232E40] text-2xl  md:text-[32px] font-bold mb-4 md:leading-[44px] ">Добро пожаловать в нашу семью арендодателей!</h2>
