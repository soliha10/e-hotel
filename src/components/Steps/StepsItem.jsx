...
const StepsItem = ({stepNum, name, text}) => {
  return (
    <li className="flex flex-col justify-center  items-center md:items-start md:justify-start md:w-[486px] " >
      ...
      <p className="text-[#777E90] min-[380px]:text-xs md:text-left"> {text}</p>
    </li>
  )
}
