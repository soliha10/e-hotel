...
const DetailForm = () => {
  return (
    <div className='w-[384px]  pb-[30px] bg-white rounded-2xl shadow-[0px 40px 32px -32px rgba(119, 126, 144, 0.10)] '>
      <div className='flex justify-between items-center px-6 pt-[22px] pb-[18px] border-b border-[#FAFAFA] '>
      ...
      <div className="px-6 pt-[18px] ">
        ...
        <form action="" className="flex items-center flex-wrap gap-x-4 ">
